...
def check_dot_command():
    if shutil.which("dot") is None:
        raise Exception(
            "The 'dot' command is not available. Please install Graphviz (https://graphviz.org) "
...
latex_documents = [
    ("index", "inmanta.tex", "Inmanta Documentation", "Inmanta NV", "manual"),
]
...
man_pages = [("index", "inmanta", "Inmanta Documentation", ["Inmanta NV"], 1)]
...
texinfo_documents = [
    ("index", "Inmanta", "Inmanta Documentation", "Inmanta NV", "Inmanta", "One line description of project.", "Miscellaneous"),
]
