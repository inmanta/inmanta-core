...
3. Annotations are used to control how the attirbute is rendered in the web console:
...
take from a service that supports a number of topology files that are part of a folder in an inmanta module. When the
