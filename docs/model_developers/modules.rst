...
You will also need to specify the url of the repository to the inmanta server. This can be done in the ``project.yml`` file of your project. (See: :ref:`specify_location_pip`)
