...
from :py:class:`pydantic.BaseModel`. To produce the JSON representation of the object, ``model.model_dump_json()`` is called. See the
`pydantic documentation <https://pydantic.dev/docs/validation/latest/concepts/serialization/#json-mode>`_
