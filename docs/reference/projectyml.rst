...
Project.yml defines the following settings:
    ...
    * ``freeze_operator`` This key determines the comparison operator used by the freeze command.
 ...
 module.yml defines the following settings:
    ...
    * ``name`` An optional name of the module.
    * ``description`` An optional description of the module
    * ``license`` The license for this module
    * ``compiler_version`` The minimal compiler version required to compile this module.
