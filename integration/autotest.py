...
def setup(env, purge=False):
    ...
    # export to env
    version = project.export(env, "/tmp/autotest/demo/export1.log", envvars={"branch": "issues/odm"})
    ...
    version = project.export(env, "/tmp/autotest/demo/export2.log", envvars={"branch": "issues/odm"})
