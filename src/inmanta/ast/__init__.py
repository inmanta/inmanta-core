...
class CompilerException(Exception, export.Exportable):
    ...
    def __init__(self, msg: str) -> None:
        LOGGER.debug('WTDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD')
        Exception.__init__(self, msg)
        LOGGER.debug('WTDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDAFTER')
...
class RuntimeException(CompilerException):
    ...
    def __init__(self, stmt: "Optional[Locatable]", msg: str) -> None:
        LOGGER.debug(f"WTDDDDDDDDDDDDDD")
        CompilerException.__init__(self, msg)
        LOGGER.debug(f"WTDDDDDDDDDDDDDDafter")
        LOGGER.debug(f"RUNTIMEEXPECTION {stmt=}")
        self.stmt = None
        if stmt is not None:
