...
#     installed_versions: Mapped[Optional[list]] = mapped_column(ARRAY(Integer()))
#
...
#         Index(
#             "resource_persistent_state_environment_resource_id_value_res_idx", "environment",
#             "resource_id_value", "resource_id"
#         ),
#         Index("resource_persistent_state_environment_resource_type_resourc_idx", "environment",
...
#         ),
#         ForeignKeyConstraint(["environment"], ["environment.id"],
#         ondelete="CASCADE", name="unknownparameter_environment_fkey"),
