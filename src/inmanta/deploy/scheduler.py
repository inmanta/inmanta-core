        ...
        *,
        ...
        if all_listeners:
            ...
            self._work.deploy_with_context(
                all_listeners,
                reason=(
                    f"Deploy was triggered because a recovery event was received from {resource_id}."
                    if recovered_from_failure
                    else f"Deploy was triggered because an event was received from {resource_id}."
                ),
                priority=priority,
                deploying=self._deploying_latest,
