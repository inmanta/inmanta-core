...
class AgentQueues:
    ...
    def bump_in_progress_priorities(self, resources: Set[ResourceIdStr], priority: TaskPriority) -> None:
        """
        Bump the priority for currently running tasks. Affects priority of new tasks generated by event propagation when these
        tasks finish.
        """
...
class ScheduledWork:
    ...
    def _queue_if_ready(self, blocked_deploy: BlockedDeploy) -> None:
        ...
        self.agent_queues.queue_put_nowait(
            blocked_deploy.task, priority=blocked_deploy.priority, priority_tiebreaker=blocked_deploy.priority_tiebreaker
        )
