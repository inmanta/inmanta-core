...
from inmanta.dto import LEGACY_PIP_DEFAULT, PipConfig
...
{add_site_dir_statements}
    ...
    def get_protected_inmanta_packages(cls) -> list[str]:
        ...
        """
        # Imported here to keep the server bootloader, and through it the database layer, out of the compiler's import graph.
