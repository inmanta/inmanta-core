...
from strawberry_sqlalchemy_mapper.mapper import StrawberrySQLAlchemyLazy, BaseModelType, _IS_GENERATED_CONNECTION_TYPE_KEY, _GENERATED_FIELD_KEYS_KEY
...
async def get_connection(
    ...
    last: typing.Optional[int] = strawberry.UNSET,
    before: typing.Optional[str] = strawberry.UNSET,
) -> CustomListConnection[typing.Any]:
    """
    ...
    async with get_session() as session:
        ...
        connection = cast(CustomListConnection, mapper._connection_type_for(model))
