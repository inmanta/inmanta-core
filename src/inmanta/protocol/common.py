...
from typing import TYPE_CHECKING, Any, Generic, TypeVar, Union, cast, get_type_hints
...
class MethodProperties:
    ...
    def _encode_dict_for_get(self, query_param_name: str, query_param_value: dict[str, Any | list[Any]]) -> dict[str, str]:
