...
@auth(auth_label=const.AuthorizationLabel.CLAIM_READ, read_only=True)
...
@auth(auth_label=const.AuthorizationLabel.CLAIM_WRITE, read_only=False)
@typedmethod(path="/claim/<username>/<key>", operation="DELETE", client_types=[ClientType.api], api_version=2)
def delete_claim(username: str, key: str) -> None:
    """
    ...
    :param key: The name of the claim that should be deleted.
    """
