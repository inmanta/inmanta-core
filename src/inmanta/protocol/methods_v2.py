...
@typedmethod(path="/claim", operation="POST", client_types=[ClientType.api], api_version=2)
def set_claim(username: str, claim_name: str, claim_value: str) -> None:
    ...
    This operation only impacts the claims included in tokens generated by the login() endpoint.

    :param username: The username that should get the claim.
    :param claim_name: The name of the claim.
    :param claim_value: The value of the claim.
    """


@auth(auth_label=const.AuthorizationLabel.CLAIM_WRITE, read_only=False)
@typedmethod(path="/claim/<claim_name>", operation="DELETE", client_types=[ClientType.api], api_version=2)
def delete_claim(username: str, claim_name: str) -> None:
    """
    Delete the claim with the given name from the authorization token of the given user.
    This operation only impacts the claims included in tokens generated by the login() endpoint.

    :param username: The username this claim should be deleted for.
    :param claim_name: The name of the claim that should be deleted.
    """
