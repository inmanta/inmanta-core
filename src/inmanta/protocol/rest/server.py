...
class WebsocketHandler(tornado_websocket.WebSocketHandler, websocket.WebsocketFrameDecoder):
    ...
    # write_message is inherited from tornado.WebSocketHandler (returns Future[None]) and
    # satisfies WebsocketFrameDecoder's abstract contract — no override needed here.
