        ...
        if resource_id is not None and resource_id != "":
            ...
            if (
                ...
                if client is not None:
                    await client.get_parameter(env_id, agent, res.to_dict())
...
class AutostartedAgentManager(ServerSlice, inmanta.server.services.environmentlistener.EnvironmentListener):
    ...
    async def _get_agent_config(
        ...
        agent_config_overrides: dict[inmanta.config.Option[typing.Any], str | None] = {
            ...
            agent_cfg.agent_deploy_interval: cast(str, await env.get(data.AUTOSTART_AGENT_DEPLOY_INTERVAL)),
            agent_cfg.agent_repair_interval: cast(str, await env.get(data.AUTOSTART_AGENT_REPAIR_INTERVAL)),
            # agent transport
