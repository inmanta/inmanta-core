...
class Connection(metaclass=ConnectionMeta):
    def __init__(self, protocol: Any, transport: Any, loop: Any, addr: None, config: connect_utils._ClientConfiguration, params: connect_utils._ConnectionParameters) -> Any: ...
    ...
    def cursor(self, query: Any, *args: Any, prefetch: Optional[Any] = ..., timeout: Optional[Any] = ...) -> CursorFactory: ...
    ...
    async def copy_records_to_table(self, table_name: str, records: Any, *, columns: Optional[str] = ..., schema_name: Optional[str] = ..., timeout: Optional[float] = ...) -> str: ...
