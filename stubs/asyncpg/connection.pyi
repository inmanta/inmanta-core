...
class Connection:
    ...
    async def _copy_in(self, copy_stmt: str, source: AsyncIterable[bytes], timeout: int) -> None: ...

async def connect(dsn: Optional[Any] = ..., *, host: Optional[Any] = ..., port: Optional[Any] = ..., user: Optional[Any] = ..., password: Optional[Any] = ..., passfile: Optional[Any] = ..., database: Optional[Any] = ..., loop: Optional[Any] = ..., timeout: float = ..., statement_cache_size: int = ..., max_cached_statement_lifetime: int = ..., max_cacheable_statement_size: Any = ..., command_timeout: Optional[Any] = ..., ssl: Optional[Any] = ..., connection_class: Any = ..., server_settings: Optional[Any] = ...) -> Connection: ...
