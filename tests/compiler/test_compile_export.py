...
def export_to_file(path: Path, expected_error_type: type[CompilerException] | None = None) -> CompileData:
    """
...
@pytest.fixture
def tempfile_export(tmp_path: Path) -> Callable[[type[CompilerException] | None], CompileData]:
    def do_export(expected_error_type: type[CompilerException] | None = None) -> CompileData:
