...
def test_is_defined_attribute(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
...
def test_is_defined_attribute_not(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
...
def test_is_defined_attribute_not_2(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
...
def test_is_defined_attribute_not_3(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
...
def test_is_defined_relation(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
...
def test_is_defined_relation_not(snippetcompiler, capsys):
    snippetcompiler.setup_for_snippet(
        """
