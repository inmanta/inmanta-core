...
async def server_config(event_loop, inmanta_config, postgres_db, database_name, clean_reset):
    ...
    config.Config.set("database", "connection_pool_min_size", str(12))
    config.Config.set("database", "connection_pool_max_size", str(24))
    config.Config.set("database", "connection_timeout", str(72))
