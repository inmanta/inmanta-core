...
@resources.resource("minimaldeployfailuremodulev2::FailBasedOnFileContent", agent="agent", id_attribute="name")
...
@provider("minimaldeployfailuremodulev2::FailBasedOnFileContent", name="wait_for_file")
