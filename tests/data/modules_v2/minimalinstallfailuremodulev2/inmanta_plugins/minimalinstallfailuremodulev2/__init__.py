...
class CodeInstallErrorResource(resources.PurgeableResource):
    """
    This resource's handler will raise an exception during code loading by the executor.
    """
...
@provider("minimalinstallfailuremodulev2::CodeInstallErrorResource", name="wait_for_file")
...
@reference("minimalinstallfailuremodulev2::FooReference")
