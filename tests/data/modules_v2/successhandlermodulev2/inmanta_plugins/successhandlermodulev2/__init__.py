...
@resources.resource("successhandlermodulev2::SuccessResource", agent="agent", id_attribute="name")
...
@provider("successhandlermodulev2::SuccessResource", name="wait_for_file")
...
@resources.resource("successhandlermodulev2::SuccessResourceWithReference", agent="agent", id_attribute="name")
...
@provider("successhandlermodulev2::SuccessResourceWithReference", name="wait_for_file")
...
@reference("successhandlermodulev2::FooReference")
