...
def test_project_install(
    ...
    metadata: module.ProjectMetadata = setup_simple_project(
        ...
        python_requires=[Requirement.parse(module.ModuleV2.get_package_name_for(mod)) for mod in install_module_names],
    )
...
def test_project_install_modules_cache_invalid(
    ...
    project: module.Project = snippetcompiler_clean.setup_for_snippet(
        ...
        python_requires=[Requirement.parse(module.ModuleV2.get_package_name_for(main_module))],
    )
...
def test_project_install_incompatible_versions(
    ...
    snippetcompiler_clean.setup_for_snippet(
        ...
        python_requires=[Requirement.parse(module.ModuleV2.get_package_name_for("v2mod"))],
    )
...
def test_project_install_incompatible_dependencies(
    ...
    snippetcompiler_clean.setup_for_snippet(
        ...
        python_requires=[
            Requirement.parse(module.ModuleV2.get_package_name_for(module.ModuleV2.get_name_from_metadata(metadata)))
