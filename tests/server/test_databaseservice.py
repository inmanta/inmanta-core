...
async def set_pool_size_to_one():
    ...
    """
    save_min_size = opt.db_service_connection_pool_min_size.get()
    save_max_size = opt.db_service_connection_pool_max_size.get()

    opt.db_service_connection_pool_min_size.set("1")
    opt.db_service_connection_pool_max_size.set("1")

    yield

    opt.db_service_connection_pool_min_size.set(str(save_min_size))
    opt.db_service_connection_pool_max_size.set(str(save_max_size))
