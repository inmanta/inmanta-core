...
def test_load_module_v2_module_using_install(
    ...
    project: Project = snippetcompiler_clean.setup_for_snippet(
        snippet=f"import {module_name}", index_url=local_module_package_index, install_project=False
    )
    assert module_name not in project.modules
    assert module_name not in os.listdir(project.downloadpath)
    if install:
...
def test_load_module_module_not_found(snippetcompiler_clean, allow_v1: bool) -> None:
    ...
    project: Project = snippetcompiler_clean.setup_for_snippet(
        snippet=f"import {module_name}", install_project=False, index_url="non_existing_local_index"
    )
    with pytest.raises(ModuleNotFoundException, match=f"Could not find module {module_name}"):
...
def test_load_module_recursive_v2_module_depends_on_v1(
    ...
    project = snippetcompiler.setup_for_snippet(
        ...
        index_url=local_module_package_index,
        python_requires=[parse_canonical_requirement(requirement="inmanta-module-v2-depends-on-v1")],
        install_project=False,
    )
...
def test_load_module_recursive_complex_module_dependencies(local_module_package_index: str, snippetcompiler) -> None:
    ...
    project = snippetcompiler.setup_for_snippet(
        ...
        autostd=False,
        index_url=local_module_package_index,
        python_requires=[parse_canonical_requirement(requirement="inmanta-module-complex-module-dependencies-mod1")],
        install_project=False,
    )
...
def test_load_import_based_v2_project(local_module_package_index: str, snippetcompiler_clean) -> None:
    ...
    load([parse_canonical_requirement(requirement=ModuleV2Source.get_package_name_for(module_name))])
...
def test_load_import_based_v2_module(
    ...
    project: Project = snippetcompiler_clean.setup_for_snippet(
        ...
        python_requires=(
            [] if v1 else [parse_canonical_requirement(requirement=ModuleV2Source.get_package_name_for(main_module_name))]
        ),
    )
...
def test_project_requirements_dont_overwrite_core_requirements_source(
    ...
    module_from_template(
        ...
        module_path,
        new_requirements=[parse_canonical_requirement(requirement="Jinja2==2.11.3")],
    )
...
def test_module_conflicting_dependencies_with_v2_modules(
    ...
    create_python_package(
        ...
        requirements=[parse_canonical_requirement(requirement="x~=1.0.0")],
        publish_index=index,
    )
    ...
    module_from_template(
        ...
        module_path1,
        new_requirements=[parse_canonical_requirement(requirement="y~=1.0.0")],
        publish_index=index,
    )
    ...
    module_from_template(
        ...
        new_requirements=[parse_canonical_requirement(requirement="x~=2.0.0")],
        publish_index=index,
    )
...
def test_module_conflicting_dependencies_with_v1_module(
    ...
    module_from_template(
        ...
        module_path2,
        new_requirements=[parse_canonical_requirement(requirement="y~=2.0.0")],
        publish_index=index,
    )
...
def test_module_install_extra_on_project_level_v2_dep(
    ...
    module_from_template(
        ...
        new_requirements=[],
        new_extras={
            "myfeature": [parse_canonical_requirement(requirement=package_name_extra)],
        },
        publish_index=index,
    )
...
def test_module_install_extra_on_dep_of_v2_module(
    ...
    snippetcompiler_clean.setup_for_snippet(
        ...
        index_url=index.url,
        extra_index_url=[local_module_package_index, "https://pypi.org/simple"],
        python_requires=[parse_canonical_requirement(requirement="inmanta-module-myv2mod")],
        autostd=False,
    )
...
def test_module_install_extra_on_dep_of_v2_module_update_scenario(
    ...
    snippetcompiler_clean.setup_for_snippet(
        ...
        index_url=index.url,
        extra_index_url=[local_module_package_index, "https://pypi.org/simple"],
        python_requires=[parse_canonical_requirement(requirement="inmanta-module-myv2mod==1.0.0")],
        autostd=False,
    )
    assert_installed(extra_installed=False)
    ...
    project: Project = snippetcompiler_clean.setup_for_snippet(
        ...
        index_url=index.url,
        extra_index_url=[local_module_package_index, "https://pypi.org/simple"],
        python_requires=[parse_canonical_requirement(requirement="inmanta-module-myv2mod==2.0.0")],
        autostd=False,
    )
    if do_project_update:
        project_tool = ProjectTool()
...
async def test_v1_module_depends_on_third_party_dep_with_extra(
    ...
    v1_module_from_template(
        ...
        new_name="myv1mod",
        new_content_init_cf="",
        new_requirements=[parse_canonical_requirement(requirement="pkg[optional-a]")],
    )
    project: Project = snippetcompiler_clean.setup_for_snippet(
        "import myv1mod",
        install_project=True,
    ...
    v1_module_from_template(
        ...
        new_name="myv1mod",
        new_content_init_cf="",
        new_requirements=[parse_canonical_requirement(requirement="pkg[optional-a,optional-b]")],
    )
    project: Project = snippetcompiler_clean.setup_for_snippet(
        "import myv1mod",
        install_project=True,
