...
async def test_cleanup_old_agents(server):
    """
    This test is testing the functionality of cleaning up old agents in the database that are no longer present in the
    currently released version of the configuration model. The test creates 2 environments and adds agents with various
